...
def _apply_rope_fp32(t, freqs, config, cu_seqlens=None, mscale=1.0, cp_group=None, max_seqlen=None, **kwargs):
...
def _apply_rope_fp32_no_cp(t, freqs, config, cu_seqlens=None, mscale=1.0, cp_group=None, max_seqlen=None, **kwargs):
    ...
    return _apply_rope_fp32(
        t, freqs, config, cu_seqlens, mscale, cp_group=_NO_CP_GROUP, max_seqlen=max_seqlen, **kwargs
    )
