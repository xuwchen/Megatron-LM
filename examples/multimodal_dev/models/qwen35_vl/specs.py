...
def _apply_rope_fp32(t, freqs, config, cu_seqlens=None, mscale=1.0, cp_group=None, **kwargs):
...
def _apply_rope_fp32_no_cp(t, freqs, config, cu_seqlens=None, mscale=1.0, cp_group=None, **kwargs):
