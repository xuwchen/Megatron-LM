...
class PackedDocumentPlanGenerator:
    ...
    @property
    def total_logical_tokens(self) -> int:
        return sum(w.logical_tokens for w in self._windows)

    @property
    def total_supervised_tokens(self) -> int:
        return sum(w.supervised_tokens for w in self._windows)

    @property
    def total_vision_tokens(self) -> int:
        return sum(w.vision_tokens for w in self._windows)
