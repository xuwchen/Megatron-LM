...
def pack_or_pad_batch(
        ...
        try:
            ...
            if max_seqlens > seq_length:
                ...
                raise ValueError(
                    ...
                    f"{seq_length}. The padded BSHD path never truncates; over-length "
                    "data is a dataset-provider bug."
                )
    ...
    _check_vision_patch_budget(padded_batch["pixel_values"], padded_batch["image_grid_thw"], args)
    return padded_batch
