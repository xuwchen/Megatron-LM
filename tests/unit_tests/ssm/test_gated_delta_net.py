...
def test_deterministic_mode_covers_every_nondeterministic_kernel():
    ...
    src = inspect.getsource(gdn._prepare_qkv_for_gated_delta_rule
                            if hasattr(gdn, "_prepare_qkv_for_gated_delta_rule")
                            else gdn.GatedDeltaNet._prepare_qkv_for_gated_delta_rule)
