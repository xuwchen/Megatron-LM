...
def test_gated_delta_split_tensor_factory_handles_cross_section_fsdp_shards(dp_rank, expected):
    ...
    actual = [
        (chunk.key.rsplit(".", 1)[-1], chunk.local_shape[0], chunk.global_offset[0])
        for chunk in chunks
    ]
