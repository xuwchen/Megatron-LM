...
class PlannedBucketAllocator(TemporaryBucketAllocator):
    ...
    def freeze_plan(self, graph_bucket_ids: Iterable[int], capture_resident: bool = False) -> None:
        ...
        Args:
            ...
            capture_resident: Whether capture holds all graph buckets resident,
                requiring a separate color for every same-offset bucket.
