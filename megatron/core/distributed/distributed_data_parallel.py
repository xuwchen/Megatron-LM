        ...
        def hook(*unused):
            ...
            if param in self.param_to_bucket_group:
                ...
                if self.ddp_config.overlap_grad_reduce:
                    # GTP_remat writes the reduce-scattered wgrad directly to main_grad and
                    # invokes this hook manually after that write, so param.grad is expected to
                    # remain None. Preserve the regular DDP safety check for every other param.
